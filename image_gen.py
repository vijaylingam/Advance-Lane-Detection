...
for idx, fname in enumerate(images):
	...
	c_binary = color_threshold(img, sthresh = (100, 255), vthresh = (40, 255))
	...
	curve_centers = tracker(Mywindow_width = window_width, Mywindow_height = window_height, Mymargin = 30, My_ym = 30/720, My_xm = 3.7/700, Mysmooth_factor = 10)
